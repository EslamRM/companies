<template>
  <div id="app">
    ...
    <div
      class="shadow-lg w-full bg-white max-w-md h-full md:h-auto fixed bottom-3 right-3 z-50"
    >
      <!-- Modal content -->
      <div class="p-4 relative rounded-lg dark:bg-gray-700">
        <!-- Modal header -->
        <div
      ...
      <!-- Modal footer -->
      <div
        class="flex items-center justify-between bg-gray-100 rounded-b border-t border-gray-200 dark:border-gray-600 p-3"
      >
        <input
          type="text"
...
export default {
  ...
  data() {
    return {
      contacts: ["eslam", "afsal", "muaath", "hammed"],
      userName: "",
      showMessage: "",
      messages: [],
      to: "test",
