...
export default {
  ...
  methods: {
    getimgbanner() {
      this.$emit("banner", this.updatedBanner);
    },
    chooseFile() {
    ...
    saveImage() {
      this.update_banner(this.$route.query.id);
      this.before_crop = true;
      this.isCropped = false;
      this.ShowChooseFile = true;
    },
    update_banner(id) {
      ...
      instance
        .post("/council/change_cover_image/" + id, formData, {
          headers: {
    ...
    chooseImage($event) {
      ...
      reader.onload = function (e) {
        ...
        image.onload = function () {
          ...
          if (height < 210 || width < 410) {
            this.showAlert();
            // this.swal(
            //   "Please choose file which has minimum height of 210 and width of 410"
            // );
            return false;
          }
